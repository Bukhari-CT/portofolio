      ...
      <div className="max-w-container h-full mx-auto py-1 font-bodyFont flex items-center justify-center">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          <ul className="flex text-[13px] gap-7">
            <Link
              className="flex items-center gap-1 font-medium text-textDark hover:text-textDarkBlue cursor-pointer duration-300 nav-link"
              href="#home"
        ...
        <div
          ...
          className="w-6 h-5 flex flex-col justify-between items-center mdl:hidden text-4xl text-textDarkBlue cursor-pointer overflow-hidden group"
        >
          <span className="w-full h-[2px] bg-textDarkBlue inline-flex transform group-hover:translate-x-2 transition-all ease-in-out duration-300"></span>
          <span className="w-full h-[2px] bg-textDarkBlue inline-flex transform translate-x-3 group-hover:translate-x-0 transition-all ease-in-out duration-300"></span>
          <span className="w-full h-[2px] bg-textDarkBlue inline-flex transform translate-x-1 group-hover:translate-x-3 transition-all ease-in-out duration-300"></span>
        </div>
        {show && (
          <div
          ...
          >
            ...
            >
              <MdOutlineClose
                ...
                className="text-3xl text-textDarkBlue cursor-pointer hover:text-red-500 absolute top-4 right-4"
              />
              <div className="flex flex-col items-center gap-7">
                ...
                {/* <a href="/assets/noor_resume.pdf" target="_blank">
                  <motion.button
                    ...
                    className="w-32 h-10 rounded-md text-textDarkBlue text-[13px] border border-textDarkBlue hover:bg-hoverColor duration-300"
                  >
                    Resume
                  </motion.button>
                </a> */}
              ...
              <motion.a
                ...
                className="text-sm w-72 tracking-widest text-textDarkBlue text-center mt-4"
